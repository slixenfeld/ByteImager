...
public class FileEncodingPane extends EncodingPane implements UIDefault, ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
    	if (e.getSource() == encodeButton) 
    		MainWindow.preview.updateImage(MainWindow.encoder.encode(FileManager.loadFileIntoArray(FileManager.chooseFile(this))));
    	else if (e.getSource() == decodeButton) {
    		outputText.setText(MainWindow.encoder.decodeToText(MainWindow.preview.getImage()));
    		 MainWindow.encoder.decodeToFile(this, MainWindow.preview.getImage());
    	}
    }
}
